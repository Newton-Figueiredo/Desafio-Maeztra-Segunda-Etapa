                        ...
                        <div className="justify-start flex flex-auto">
                            <div className="mb-0 lg:w-full w">
                                <div className="input-group  flex items-stretch w-full mb-0 ">
                                    <input type="search" className="form-control flex-auto min-w-0 w-full pl-5 pr-[200px] py-1 text-base font-normal text-gray-700 bg-[#ffffff] bg-clip-padding border border-black rounded-lg transition ease-in-out m-0 focus:text-gray-700 focus:bg-[#eeeeee] focus:border-blue-600 focus:outline-none placeholder-[#353535]" placeholder="Digite seu e-mail" aria-label="Search" aria-describedby="button-addon3" style={{"border-radius":"4px","margin-right":"10px"}} />
